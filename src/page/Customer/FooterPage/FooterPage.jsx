  ...
  return (
    ...
    >
          ...
          <div className='row' style={{ justifyContent: 'space-between', alignItems: 'flex-start', marginBottom: '8rem' }}>
            <div className='column' style={{ gap: '1rem' }}>
              <div style={{ position: "relative", fontSize: '1.5rem', fontWeight: 'bold', color: 'white', letterSpacing: '0.1rem' }}>
                ...
                />
                {getValue(parameterBindData, 'page6_bottom_text1__text') || '客服热线'}
              </div>
              <div style={{ position: "relative", fontSize: '2rem', fontWeight: 'bold', color: 'white', letterSpacing: '0.1rem' }}>
                ...
                />
                {getValue(parameterBindData, 'page6_bottom_text2__text') || '0512-55230818'}
              </div>
              <div style={{ position: "relative", fontSize: '1.5rem', fontWeight: 'bold', color: 'white', letterSpacing: '0.1rem' }}>
                <TextBind
                  data={parameterBindData}
                ...
                />
                <EnvironmentOutlined style={{ marginRight: '0.5rem' }} />{getValue(parameterBindData, 'page6_bottom_text3__text') || '地址'}
              </div>
              <div style={{ position: "relative", fontSize: '0.75rem', fontWeight: 'bold', color: 'white', letterSpacing: '0.1rem' }}>
                ...
                />
                {getValue(parameterBindData, 'page6_bottom_text4__text') || '江苏省苏州市昆山市祖冲之南路1699号1号楼101室'}
              </div>
            </div>
            {/* 解决方案 */}
      ...
      <div style={{ position: "relative", textAlign: "center", fontSize: "0.8rem", color: '#989898', marginBottom: "2rem" }}>
        ...
        />
        {getValue(parameterBindData, 'page6_bottom_text5__text') || '版权所有 江苏比尔信息科技有限公司苏ICP备00000000号'}
      </div>
      <div style={{ position: "relative", textAlign: "center", fontSize: "0.8rem", color: '#989898' }}>
        ...
        />
        {getValue(parameterBindData, 'page6_bottom_text6__text') || '比尔信息产品：qms软件开发、spc分析软件、fmea软件、8d品质管理系统、质量管理8d软件、fmea失效分析系统、qms质量管理系统软件开发等，欢迎咨询FMEA开发公司。'}
      </div>
    </div>
  );
};
