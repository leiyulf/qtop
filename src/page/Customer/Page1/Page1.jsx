        ...
        >
          ...
          >
            ...
            >
              ...
              />
              {getValue(globalDataBindData, 'page1_main_title__text') || 'Q-TOP ® = 质量视角 + 信息化手段'}
            </div>
            <div style={{
              position: "relative",
              fontSize: "2rem",
              ...
              />
              {getValue(globalDataBindData, 'page1_contact_title__text') || 'Q-TOP ® = 质量视角 + 信息化手段'}
            </div>
          </div>
        ...
        >
          <div
            style={{
              width: "100%",
              height: "100%",
              backgroundImage: `url(${getValue(globalDataBindData, 'page1_background__image') || '/image/background.jpg'})`,
